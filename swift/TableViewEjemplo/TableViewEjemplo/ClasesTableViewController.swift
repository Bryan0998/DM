...
class ClasesTableViewController: UITableViewController, ClasesViewControllerDelegate {
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return cManager.numeroClases
    }

    
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "clasesID", for: indexPath)
        
        let clase = cManager.leerClase(at: indexPath.row)
